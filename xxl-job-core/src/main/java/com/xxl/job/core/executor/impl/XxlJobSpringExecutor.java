...
public class XxlJobSpringExecutor extends XxlJobExecutor implements ApplicationContextAware, InitializingBean, DisposableBean {
    ...
    private boolean autoStartRpcProvider = true;

    public void setAutoStartRpcProvider(boolean autoStartRpcProvider) {
        this.autoStartRpcProvider = autoStartRpcProvider;
    }
